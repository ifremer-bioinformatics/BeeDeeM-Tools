...
# *** TEST 1/4: index a sequence file
echo "> 1/4: Running 'index.sh' tool:"
...
# *** TEST 2/4: query the created index
echo "> 2/4: Running 'query.sh' tool:"
...
# *** TEST 3/4: cut a sequence into slices of 1000 sequences each
